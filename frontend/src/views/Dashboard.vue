  ...
  <div>
    ...
    <div class="main">
        ...
        <div class="container dashboard">
            ...
            <div class="sections small-section">

                <div class="section-container">

                    <a class="section-add" href="new-todo.html" >
                    ...
                    <!-- star card X3-->
                    <div class=" card-small cards-hover">
                        <a href="detail.html" class="card-link">
                            <div class="">
                                <p class="card-titre" style="margin:0;"><span>28/05</span> | Nom du cou.. </p>
                                <p class="card-soustitre" style="margin-bottom:0;">La tâche : Lorem , ... </p>
                            </div>
                        </a>
            ...
            <div class="sections small-section">
                <div class="section-container">
                    ...
                    <a href="new.html" class="section-add">
                        <div class="add-container">
                            <div class="card-add">
                                <div type="text" name="coursname" class="field-add"> Créer une note</div>
                                <button class="icon-plus">
                                    <svg fill="currentColor" width="30" height="30" viewBox="0 0 448 448"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                    ...
                    <div class=" card-small cards-hover">
                        <a href="detail.html" class="card-link">
                            ...
                            <div class="card-soustitre">Nom du cours</div>
                        </a>
                        <div class="card-icons">
                            <div class=" icons-container">
                                <a href="" class="icon-edit">
            ...
            <div class="sections small-section">
                <div class="section-container">
                    ...
                    <div class="section-add">
                        ...
                        <!-- MODIFIER COURS FORM
                        <div class="add-container display-none"> 
                            <form class="card-add edit-cours">
    
                                <input type="text" name="coursname"  class="field-add" value="Nom du cours à modifier">
                                <button class="icon-plus">
            ...
            <div class="sections large-section" style="height: 0;"></div>
